...
public class Facture extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtFac.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        txtFac.setRows(5);
        jScrollPane1.setViewportView(txtFac);

        jPanel1.add(jScrollPane1);
        jScrollPane1.setBounds(30, 50, 470, 400);

        jButton1.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/b_print.png"))); // NOI18N
        ...
        jButton1.setBounds(210, 460, 90, 50);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            boolean impfac = txtFac.print();
            if (impfac) {
                cg.boiteDeDialogue("Impression réussie.", "information");
            } else {
                cg.boiteDeDialogue("Impression annulée.", "information");
            }
            setVisible(false);
    ...
    public javax.swing.JTextArea txtFac;
